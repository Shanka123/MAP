...
import argparse
import os
from logistics_plan_generation_cot_examples import standard_prompt
import time
import json
...
for instance in tqdm(data["instances"]):
	...
	Give your thoughts after "Thoughts:", and then give your plan after "My actions to achieve the goal from the starting state:". Please provide each action for the plan between a [START] and a [END] token.
