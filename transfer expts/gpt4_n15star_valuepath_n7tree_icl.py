...
for room1,room2 in reward_rooms:
	...
	for start_room in range(1,16):
		if start_room!=room1 and start_room!=room2:
			...
			The shortest path from zone 1 to the zone with the highest money is: 1, 2, 4
			...
			The shortest path from zone 3 to the zone with the highest money is: 3, 1, 2, 4
			...
			Starting from room {r}, please list the room numbers in order, including {r}, separated by commas. Please limit your answer to a maximum path length of 6.
			 
			Your answer should only be in the format as below:
			The shortest path from room {r} to the room with a chest with the highest reward is: {r}, 
